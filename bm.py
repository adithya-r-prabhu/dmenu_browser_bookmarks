...
#   / ____ \| | \ \| |       
#  /_/    \_\_|  \_\_|       
# Python Script that Lets u open bookmarks from Dmenu..Bookmarks are stored in a html file exported from browser
       
#Browser name like firefox , microsoft-edge-stable etc in Linux
BROWSER="microsoft-edge-beta" #change with ur browser of choice

#This File must be exported from the browser 
Bookmark_path="path/to/bookmark.html" #replace with the filename(if in same directory) or path(if in seperate directory)
...
page = open(Bookmark_path)
soup = BeautifulSoup(page.read(),"lxml")
for link in soup.findAll('a'):
    list_of_urls.append(link.get('href'))

####Dmenu python Wrapper -https://github.com/allonhadaya/dmenu-python #####
...
####Dmenu python Wrapper ended#####

os.system(BROWSER +" "+ show(list_of_urls, prompt='favorites:'))
